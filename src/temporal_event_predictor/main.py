# src/temporal_event_predictor/main.py
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from temporal_event_predictor.api import router
from contextlib import asynccontextmanager
from apscheduler.schedulers.asyncio import AsyncIOScheduler
from temporal_event_predictor.core.session_manager import session_manager
from temporal_event_predictor.core.constants import CLEANUP_CONFIG
...
async def lifespan(app: FastAPI):
    ...
    from temporal_event_predictor.core.security.admin_auth import admin_auth
